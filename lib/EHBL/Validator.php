...
class Validator
{
	 ...
	 */
	public function __construct(public Packager $packager) {}

	public static function compare(Packager $zipPackage, Packager $ehmPackage)
	{
	...
	public function compareWith(Packager $otherPackage)
	{
	...
	private function missionDiff(string $hexA, string $hexB)
	{
	...
	private function compareMissions(mixed $a, mixed $b, \Pyrite\TIE\Mission $aTIE, \Pyrite\TIE\Mission $bTIE, string $path = '')
	{
		$out     = [];
	...
	private function str(mixed $obj): string
	{
	...
	public static function fromPackage(Packager $package): array
	{
