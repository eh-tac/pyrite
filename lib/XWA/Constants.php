...
class Constants
{
    ...
    public static $CRAFTTYPE_MOON1 = 198;
    public static $CRAFTTYPE_MOON2 = 202;
    public static $CRAFTTYPE_SUN1 = 203;
    public static $CRAFTTYPE_SUN2 = 212;
    public static $CRAFTTYPE_BACKDROP1 = 213;
    public static $CRAFTTYPE_BACKDROP2 = 226;
    ...
    public static $HANGAR_TUTORIAL = 0;
    public static $HANGAR_OBSTACLE = 1;
    public static $HANGAR_MELEE = 2;
    public static $HANGAR_EXERCISE = 3;
    ...
    public static $BRIEFINGOFFICER_WEDGE = 3;
    public static $BRIEFINGOFFICER_NAMMO = 4;
    public static $BRIEFINGOFFICER_YAMARUS = 5;
    public static $BRIEFINGOFFICER_ACKBAR = 6;
    public static $BRIEFINGOFFICER_AERON = 7;
    public static $BRIEFINGOFFICER_EMKAY = 8;
    public static $BRIEFINGOFFICER_ANTAN = 9;
    public static $BRIEFINGOFFICER_EMON = 10;
    public static $BRIEFINGOFFICER_GALIN = 11;
    ...
    public static $BRIEFINGLOGO_VECTORSQUADRON = 9;
    ...
    public static $DESIGNATIONTEAM_TEAM1 = 0;
    public static $DESIGNATIONTEAM_TEAM2 = 1;
    public static $DESIGNATIONTEAM_TEAM3 = 2;
    public static $DESIGNATIONTEAM_TEAM4 = 3;
    public static $DESIGNATIONTEAM_TEAM5 = 4;
    public static $DESIGNATIONTEAM_TEAM6 = 5;
    public static $DESIGNATIONTEAM_TEAM7 = 6;
    public static $DESIGNATIONTEAM_TEAM8 = 7;
    public static $DESIGNATIONTEAM_ALL = 8;
    public static $DESIGNATIONTEAM_OTHERS = 9;
    public static $DESIGNATIONTEAM_HOSTILE = 10;
    public static $DESIGNATIONTEAM_FRIENDLY = 11;
    public static $DESIGNATIONTEAM_REBEL = 12;
    ...
    public static array $DESIGNATION = [
        ...
        18 => "HYP to Region 3",
        19 => "HYP to Region 4",
        20 => "HYP from Any Region",
        21 => "HYP to Any Region",
    ];
    ...
    public static $DESIGNATION_RESEARCHFACILITY = 10;
    public static $DESIGNATION_MANUFACTURINGFACILITY = 11;
    ...
    public static array $STATUS = [
        ...
        2 => "1/2 Warheads",
        3 => "No Shields",
        4 => "1/2 Shields, Damaged",
        5 => "Lasers Damaged",
        6 => "Hyperdrive Damaged",
        7 => "Shields 0%, charging",
        8 => "Shields added or 200%",
        9 => "Hyperdrive added",
        10 => "2x Countermeasure",
        11 => "1/2 Countermeasures",
        12 => "200% Shields, Charging",
        13 => "50% Shields, Charging",
        14 => "No Lasers",
        15 => "Engines Damaged",
    ...
    public static $STATUS_N12SHIELDSDAMAGED = 4;
    public static $STATUS_LASERSDAMAGED = 5;
    public static $STATUS_HYPERDRIVEDAMAGED = 6;
    ...
    public static $STATUS_N200PERCENTSHIELDSCHARGING = 12;
    public static $STATUS_N50PERCENTSHIELDSCHARGING = 13;
    public static $STATUS_NOLASERS = 14;
    ...
    public static $STATUS_INSPECTED = 25;
    ...
    public static $FORMATION_REVERSEVIC = 10;
    public static $FORMATION_SIDEVIC = 11;
    public static $FORMATION_REVERSESIDEVIC = 12;
    public static $FORMATION_LINEAHEAD = 13;
    public static $FORMATION_LINEDOWN = 14;
    public static $FORMATION_LINERIGHT = 15;
    public static $FORMATION_LINELEFT = 16;
    public static $FORMATION_ECHELONFORWARD = 17;
    public static $FORMATION_ECHELONASTERN = 18;
    public static $FORMATION_ECHELONUP = 19;
    public static $FORMATION_ECHELONDOWN = 20;
    public static $FORMATION_VICUP = 21;
    public static $FORMATION_VICDOWN = 22;
    public static $FORMATION_DOUBLEASTERNMIRROR = 23;
    public static $FORMATION_DOUBLESIDE = 24;
    public static $FORMATION_DOUBLEDOWN = 25;
    public static $FORMATION_SIDEDIAMOND = 26;
    public static $FORMATION_FRONTDIAMOND = 27;
    public static $FORMATION_FLATSTAR = 28;
    public static $FORMATION_SIDESTAR = 29;
    public static $FORMATION_FRONTSTAR = 30;
    ...
    public static $FORMATIONSPACING_TOOTIGHT = 0;
    public static $FORMATIONSPACING_VERYTIGHT = 1;
    public static $FORMATIONSPACING_TIGHT = 2;
    public static $FORMATIONSPACING_COMFY = 3;
    public static $FORMATIONSPACING_CLOSE = 4;
    public static $FORMATIONSPACING_MODERATE = 5;
    public static $FORMATIONSPACING_STANDARD = 6;
    public static $FORMATIONSPACING_SAFE = 7;
    public static $FORMATIONSPACING_LOOSE = 8;
    ...
    public static $STOPARRIVINGWHEN_NEVERALWAYSARRIVES = 0;
    public static $STOPARRIVINGWHEN_MISSIONCOMPLETE = 1;
    ...
    public static array $CONDITION = [
        ...
        37 => "25% Hull",
        38 => "Time less than",
        39 => "Be picked up for team",
        40 => "NOT be picked up by team",
        41 => "Have Player craft",
        42 => "Not have Player craft",
        43 => "Come and go",
        44 => "Captured and gone",
        45 => "Withdraw",
        46 => "Be carried away",
    ...
    public static $CONDITION_LASERSDOWN = 24;
    public static $CONDITION_NOTCREATED = 25;
    public static $CONDITION_NOTBEATTACKED = 26;
    public static $CONDITION_NOTBEDISABLED = 27;
    public static $CONDITION_NOTBECAPTURED = 28;
    public static $CONDITION_NOTBEINSPECTED = 29;
    public static $CONDITION_BEINGBOARDED = 30;
    public static $CONDITION_NOTBOARDED = 31;
    public static $CONDITION_BEGUNDOCKING = 32;
    public static $CONDITION_NOTDOCKED = 33;
    ...
    public static $CONDITION_TIMELESSTHAN = 38;
    public static $CONDITION_BEPICKEDUPFORTEAM = 39;
    public static $CONDITION_NOTBEPICKEDUPBYTEAM = 40;
    public static $CONDITION_HAVEPLAYERCRAFT = 41;
    public static $CONDITION_NOTHAVEPLAYERCRAFT = 42;
    public static $CONDITION_COMEANDGO = 43;
    public static $CONDITION_CAPTUREDANDGONE = 44;
    ...
    public static array $VARIABLETYPE = [
        ...
        5 => "IFF",
        6 => "Order (enum) (maps to None)",
        7 => "CraftWhen (enum)",
        8 => "Global Group",
        9 => "Rating (maps to None)",
        10 => "Craft with Status1 (maps to None)",
        11 => "All (maps to None)",
        12 => "Team",
        13 => "Player",
        14 => "Delay",
    ...
    public static $VARIABLETYPE_ORDERENUMMAPSTONONE = 6;
    public static $VARIABLETYPE_CRAFTWHENENUM = 7;
    public static $VARIABLETYPE_GLOBALGROUP = 8;
    public static $VARIABLETYPE_RATINGMAPSTONONE = 9;
    public static $VARIABLETYPE_CRAFTWITHSTATUS1MAPSTONONE = 10;
    public static $VARIABLETYPE_ALLMAPSTONONE = 11;
    ...
    public static $CRAFTCATEGORY_BUOYS = 7;
    public static $CRAFTCATEGORY_CONTAINERS = 8;
    ...
    public static array $ORDER = [
        ...
        23 => "SS Launch",
        24 => "SS Protect",
        25 => "*SS Wait and Protect (maps to Stationary)",
        26 => "SS Patrol and Attack",
        27 => "SS Patrol and Disable",
        28 => "*SS Hold Steady (maps to Stationary)",
        29 => "SS Go Home",
        30 => "*SS Wait (maps to Stationary)",
        31 => "SS Board",
        32 => "Board to Repair",
        33 => "*Hold Station (maps to Stationary)",
        34 => "*Hold Steady (maps to Stationary)",
        35 => "*SS Hold Station (maps to Stationary)",
        36 => "Self-destruct",
        37 => "Kamikaze",
        38 => "Orbit",
    ...
    public static $ORDER_SSWAITANDPROTECTMAPSTOSTATIONARY = 25;
    public static $ORDER_SSPATROLANDATTACK = 26;
    public static $ORDER_SSPATROLANDDISABLE = 27;
    public static $ORDER_SSHOLDSTEADYMAPSTOSTATIONARY = 28;
    public static $ORDER_SSGOHOME = 29;
    public static $ORDER_SSWAITMAPSTOSTATIONARY = 30;
    public static $ORDER_SSBOARD = 31;
    public static $ORDER_BOARDTOREPAIR = 32;
    public static $ORDER_HOLDSTATIONMAPSTOSTATIONARY = 33;
    public static $ORDER_HOLDSTEADYMAPSTOSTATIONARY = 34;
    public static $ORDER_SSHOLDSTATIONMAPSTOSTATIONARY = 35;
    public static $ORDER_SELFDESTRUCT = 36;
    public static $ORDER_KAMIKAZE = 37;
    public static $ORDER_ORBIT = 38;
    public static $ORDER_RELEASECARRIEDCARGO = 39;
    public static $ORDER_DELIVERDROPOFF = 40;
    public static $ORDER_LOAD = 41;
    public static $ORDER_STANDOFFATTACK = 42;
    public static $ORDER_BACKUP = 43;
    public static $ORDER_SHUTDOWN = 44;
    public static $ORDER_REPAIRSELF = 45;
    public static $ORDER_DEFECT = 46;
    public static $ORDER_SELFCAPTURESURRENDER = 47;
    public static $ORDER_BUILD = 48;
    ...
    public static $CRAFTWHEN_CAPTURED = 0;
    public static $CRAFTWHEN_INSPECTED = 1;
    public static $CRAFTWHEN_FINISHEDBEINGBOARDED = 2;
    public static $CRAFTWHEN_FINISHEDDOCKING = 3;
    ...
    public static $CRAFTWHEN_NOTATTACKED = 11;
    public static $CRAFTWHEN_NOTDISABLED = 12;
    public static $CRAFTWHEN_NOTCAPTURED = 13;
    public static $CRAFTWHEN_NOTINSPECTED = 14;
    public static $CRAFTWHEN_BEINGBOARDED = 15;
    public static $CRAFTWHEN_NOTBOARDED = 16;
    public static $CRAFTWHEN_ISDOCKING = 17;
    public static $CRAFTWHEN_NOTDOCKED = 18;
    public static $CRAFTWHEN_SHIELDSAT50PERCENT = 19;
    public static $CRAFTWHEN_SHIELDSAT25PERCENT = 20;
    public static $CRAFTWHEN_SHIELDSDOWN = 21;
    public static $CRAFTWHEN_HULLAT75PERCENT = 22;
    public static $CRAFTWHEN_HULLAT50PERCENT = 23;
    public static $CRAFTWHEN_HULLAT25PERCENT = 24;
    public static $CRAFTWHEN_MISSILESSPENT = 25;
    public static $CRAFTWHEN_LASERSOUT = 26;
    ...
    public static $EVENTTYPE_SEEK = 1;
    public static $EVENTTYPE_SHIPINDEX = 2;
    ...
    public static $EVENTTYPE_SETICON = 26;
    ...
    public static $TFTCCRAFTTYPE_DONTUSEME1 = 191;
    ...
    public static $TFTCCRAFTTYPE_DONTUSEME = 225;
