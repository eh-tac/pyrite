...
abstract class FlightGroupBase extends PyriteBase implements Byteable
{
    ...
    public function toHexString($hex = null)
    {
        ...
        $hex = $this->writeByte($this->Unknown1, $hex, 0x018);
        ...
        $hex = $this->writeByte($this->LeaderSpacing, $hex, 0x079);
        $hex = $this->writeByte($this->NumberOfWaves, $hex, 0x07A);
        $hex = $this->writeByte($this->Unknown3, $hex, 0x07B);
        ...
        $hex = $this->writeObject($this->Arrival1, $hex, 0x088);
        $hex = $this->writeObject($this->Arrival2, $hex, 0x08E);
        $hex = $this->writeBool($this->Arrival1OrArrival2, $hex, 0x096);
        $hex = $this->writeBool($this->Unknown6, $hex, 0x097);
        $hex = $this->writeObject($this->Arrival3, $hex, 0x098);
        $hex = $this->writeObject($this->Arrival4, $hex, 0x09E);
        $hex = $this->writeBool($this->Arrival3OrArrival4, $hex, 0x0A6);
        ...
        $hex = $this->writeObject($this->Departure1, $hex, 0x0AC);
        $hex = $this->writeObject($this->Departure2, $hex, 0x0B2);
        $hex = $this->writeBool($this->Departure1OrDeparture2, $hex, 0x0BA);
        ...
        $hex = $this->writeByte($this->Unknown7, $hex, 0x0BF);
        $hex = $this->writeByte($this->Unknown8, $hex, 0x0C0);
        $hex = $this->writeByte($this->ArrivalMothership, $hex, 0x0C2);
        $hex = $this->writeBool($this->ArriveViaMothership, $hex, 0x0C3);
        $hex = $this->writeByte($this->DepartureMothership, $hex, 0x0C4);
        $hex = $this->writeBool($this->DepartViaMothership, $hex, 0x0C5);
        $hex = $this->writeByte($this->AlternateArrivalMothership, $hex, 0x0C6);
        $hex = $this->writeBool($this->AlternateArriveViaMothership, $hex, 0x0C7);
        $hex = $this->writeByte($this->AlternateDepartureMothership, $hex, 0x0C8);
        $hex = $this->writeBool($this->AlternateDepartViaMothership, $hex, 0x0C9);
        $offset = 0x0CA;
        for ($i = 0; $i < 16; $i++) {
            $t = $this->Orders[$i];
        ...
        $hex = $this->writeByte($this->Unknown16, $hex, 0xDAE);
        $hex = $this->writeByte($this->Unknown17, $hex, 0xDAF);
        $hex = $this->writeByte($this->Unknown18, $hex, 0xDB0);
        $hex = $this->writeByte($this->Unknown19, $hex, 0xDB1);
        $hex = $this->writeByte($this->Unknown20, $hex, 0xDB2);
        $hex = $this->writeByte($this->Unknown21, $hex, 0xDB3);
        $hex = $this->writeBool($this->Unknown22, $hex, 0xDB4);
        $hex = $this->writeByte($this->Unknown23, $hex, 0xDB6);
        $hex = $this->writeByte($this->Unknown24, $hex, 0xDB7);
        $hex = $this->writeByte($this->Unknown25, $hex, 0xDB8);
        $hex = $this->writeByte($this->Unknown26, $hex, 0xDB9);
        $hex = $this->writeByte($this->Unknown27, $hex, 0xDBA);
        $hex = $this->writeByte($this->Unknown28, $hex, 0xDBB);
        $hex = $this->writeBool($this->Unknown29, $hex, 0xDBC);
        $hex = $this->writeBool($this->Unknown30, $hex, 0xDC0);
        $hex = $this->writeBool($this->Unknown31, $hex, 0xDC1);
        $hex = $this->writeBool($this->EnableGlobalUnit, $hex, 0xDC4);
        $hex = $this->writeByte($this->Unknown32, $hex, 0xDC5);
        $hex = $this->writeByte($this->Unknown33, $hex, 0xDC6);
        ...
        $hex = $this->writeByte($this->Backdrop, $hex, 0xE12);
        $hex = $this->writeBool($this->Unknown34, $hex, 0xE29);
        $hex = $this->writeBool($this->Unknown35, $hex, 0xE2B);
        $hex = $this->writeBool($this->Unknown36, $hex, 0xE2D);
        $hex = $this->writeBool($this->Unknown37, $hex, 0xE2F);
        $hex = $this->writeBool($this->Unknown38, $hex, 0xE31);
        $hex = $this->writeBool($this->Unknown39, $hex, 0xE33);
        $hex = $this->writeBool($this->Unknown40, $hex, 0xE35);
        $hex = $this->writeBool($this->Unknown41, $hex, 0xE37);
