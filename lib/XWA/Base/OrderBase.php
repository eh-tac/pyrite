...
abstract class OrderBase extends PyriteBase implements Byteable
{
    ...
    public function toHexString($hex = null)
    {
        ...
        [$hex, $offset] = $this->writeByte($this->Variable3, $hex, 0x04);
        [$hex, $offset] = $this->writeByte($this->Unknown9, $hex, 0x05);
        ...
        [$hex, $offset] = $this->writeByte($this->Speed, $hex, 0x12);
        $offset = 0x14;
        for ($i = 0; $i < 8; $i++) {
            $t = $this->Waypoints[$i];
            [$hex, $offset] = $this->writeObject($t, $hex, $offset);
        }
        [$hex, $offset] = $this->writeByte($this->Unknown10, $hex, 0x72);
        [$hex, $offset] = $this->writeBool($this->Unknown11, $hex, 0x73);
        [$hex, $offset] = $this->writeBool($this->Unknown12, $hex, 0x74);
        [$hex, $offset] = $this->writeBool($this->Unknown13, $hex, 0x7B);
        [$hex, $offset] = $this->writeBool($this->Unknown14, $hex, 0x81);
