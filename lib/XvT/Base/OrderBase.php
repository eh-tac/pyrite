...
abstract class OrderBase extends PyriteBase implements Byteable
{
    ...
    public function toHexString($hex = null)
    {
        ...
        [$hex, $offset] = $this->writeByte($this->Unknown6, $hex, 0x04);
        [$hex, $offset] = $this->writeByte($this->Unknown7, $hex, 0x05);
        ...
        [$hex, $offset] = $this->writeByte($this->Unknown8, $hex, 0x0B);
        ...
        [$hex, $offset] = $this->writeByte($this->Unknown9, $hex, 0x11);
        [$hex, $offset] = $this->writeByte($this->Speed, $hex, 0x12);
        [$hex, $offset] = $this->writeString($this->Designation, $hex, 0x13);
