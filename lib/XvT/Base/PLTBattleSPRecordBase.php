...
abstract class PLTBattleSPRecordBase extends PyriteBase implements Byteable
{
    use HexDecoder;
    use HexEncoder;

    /** @var integer  PLTBATTLESPRECORDLENGTH INT */
    ...
    public $unknown0x18;
    /** @var integer 0x001C bestEvaluationMedal INT */
    public $bestEvaluationMedal;
    /** @var integer 0x0020 bestVictoryMargin INT */
