...
abstract class PLTTournSPRecordBase extends PyriteBase implements Byteable
{
    use HexDecoder;
    use HexEncoder;

    /** @var integer  PLTTOURNSPRECORDLENGTH INT */
    ...
    /** @var integer 0x0024 bestFinishPointMargin INT */
