...
abstract class MissionXvTBase extends PyriteBase implements Byteable
{
    use HexDecoder;

    /** @var integer */
    public $MissionXvTLength;
    /** @var FileHeader */
    public $FileHeader;
    /** @var FlightGroup[] */
    public $FlightGroups;
    ...
    public function __construct($hex, $tie = null)
    {
        ...
        $this->FGGoalStrings = [];
        $offset = $offset;
        for ($i = 0; $i < $this->FileHeader->FGGoalStringCount(); $i++) {
    ...
    public function toHexString()
    {
        ...
        $this->writeString($hex, $this->MissionDescription, $offset);

        return $hex;
    }
    
    protected abstract function FileHeader-FGGoalStringCount();
    public function getLength()
    {
        return $this->MissionXvTLength;
    }
}