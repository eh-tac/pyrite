...
export enum TFTCCraftType {
  ...
  m22KraytGunship = 190,
  dontUseMe = 191,
  // duplicate dontUseMe = 192,
  // duplicate dontUseMe = 193,
  // duplicate dontUseMe = 194,
  vt49Decimator = 195,
  x4Gunship = 196,
  ye4Gunship = 197,
  // duplicate dontUseMe = 198,
  ykl37RNovaCourier = 199,
  // duplicate dontUseMe = 200,
  // duplicate dontUseMe = 201,
  nabooBarge = 202,
  coruscantCourier = 203,
  yb300LightTransport = 204,
  // duplicate dontUseMe = 205,
  // duplicate dontUseMe = 206,
