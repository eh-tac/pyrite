...
export class XWObjectGroupController extends ControllerBase {
  public readonly fields: object = {
    ...
    ObjectFormation: { name: "ObjectFormation", type: "SHORT", options: "Constants.OBJECTFORMATION" },
    NumberOfCraft: { name: "NumberOfCraft", type: "SHORT" },
    X: { name: "X", type: "SHORT" },
    Y: { name: "Y", type: "SHORT" },
    Z: { name: "Z", type: "SHORT" },
    Yaw: { name: "Yaw", type: "SHORT" },
    Pitch: { name: "Pitch", type: "SHORT" },
    Roll: { name: "Roll", type: "SHORT" },
  };
