...
export class XvTOrderController extends ControllerBase {
  public readonly fields: object = {
    ...
    Variable1: { name: "Variable1", type: "BYTE" },
    Variable2: { name: "Variable2", type: "BYTE" },
    Unknown6: { name: "Unknown6", type: "BYTE" },
    Unknown7: { name: "Unknown7", type: "BYTE" },
    ...
    Unknown8: { name: "Unknown8", type: "BYTE" },
    ...
    Unknown9: { name: "Unknown9", type: "BYTE" },
    Speed: { name: "Speed", type: "BYTE" },
    Designation: { name: "Designation", type: "STR" },
  };
