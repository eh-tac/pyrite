...
export class LFDVoicController extends ControllerBase {
  public readonly fields: object = {
    ...
    Creative: { name: "Creative", type: "CHAR" },
    Abort: { name: "Abort", type: "BYTE" },
    Version: { name: "Version", type: "BYTE" },
    VersionHash: { name: "VersionHash", type: "BYTE" },
    Data: { name: "Data", type: "VoicData", componentTag: "pyrite-lfd-voic-data", componentProp: "voicdata" },
    Terminator: { name: "Terminator", type: "BYTE" },
  };
