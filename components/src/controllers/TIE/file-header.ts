...
export class TIEFileHeaderController extends ControllerBase {
  public readonly fields: object = {
    ...
    NumGGs: { name: "NumGGs", type: "SHORT" },
    Unknown1: { name: "Unknown1", type: "BYTE" },
    Unknown2: { name: "Unknown2", type: "BOOL" },
    BriefingOfficers: { name: "BriefingOfficers", type: "BYTE", options: "Constants.BRIEFINGOFFICERS" },
    CapturedOnEject: { name: "CapturedOnEject", type: "BOOL" },
    EndOfMissionMessages: { name: "EndOfMissionMessages", type: "CHAR" },
    OtherIffNames: { name: "OtherIffNames", type: "CHAR" },
  };
