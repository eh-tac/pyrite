...
import {
  Briefing,
  Event as Event1,
  FileHeader as FileHeader1,
  FlightGroup as FlightGroup1,
  GlobalGoal as GlobalGoal1,
  GoalFG as GoalFG1,
  GoalGlobal,
  Message as Message1,
  Mission as Mission2,
  ...
  MissionData,
  Order as Order1,
  PilotFile as PilotFile1,
  PL2CampaignProgressState,
  PL2CampaignRecord,
  PL2CampaignState,
  PL2CampaignStatusSPRecord,
  PL2DebriefRecord,
  PL2FactionRecord,
  PL2FileRecord,
  PLTAIRankCountRecord,
  PLTBattleMPRecord,
  PLTBattleProgressState,
  PLTBattleSPRecord,
  PLTBattleState,
  PLTCategoryTypeRecord,
  PLTConnectedPlayerData,
  PLTEarnedMedalRecord,
  PLTFactionRecord,
  PLTFileRecord,
  PLTMissionMPRecord,
  PLTMissionSPRecord,
  PLTPlayerRankCountRecord,
  PLTTeamResultRecord,
  PLTTournamentProgressState,
  PLTTournMPRecord,
  PLTTournSPRecord,
  PLTTournTeamRecord,
  Role,
...
import {
  ...
  BriefingHeader,
  Coordinate,
  FileHeader as FileHeader2,
  FlightGroup as FlightGroup2,
  Icon,
  Mission as Mission3,
  MissionHeader,
  ObjectGroup,
  Page,
  PilotFile as PilotFile2,
  String,
  Tag as Tag2,
  ViewportSetting,
...
import {
  ...
  Event as Event2,
  FileHeader as FileHeader3,
  FlightGroup as FlightGroup3,
  GlobalCargo,
  GlobalGoal as GlobalGoal2,
  GlobalUnit,
  GoalFG as GoalFG2,
  GoalGlobal as GoalGlobal1,
  Icon as Icon1,
  Message as Message2,
  Mission as Mission4,
  MissionData as MissionData1,
  Order as Order2,
  PilotFile as PilotFile3,
  Region,
  Team as Team1,
  Trigger as Trigger2,
  TriggerPair,
...
export namespace Components {
  ...
  interface PyriteXvtPl2FileEditor {
    file?: string;
    useFileInput: (file: File) => Promise<void>;
  }
  ...
  interface PyriteXwaTriggerPair {
...
declare global {
  ...
  interface HTMLEhtcApiSelectElement extends Components.EhtcApiSelect, HTMLStencilElement {
    addEventListener<K extends keyof HTMLEhtcApiSelectElementEventMap>(
      type: K,
      listener: (
        this: HTMLEhtcApiSelectElement,
        ev: EhtcApiSelectCustomEvent<HTMLEhtcApiSelectElementEventMap[K]>,
      ) => any,
    ...
    removeEventListener<K extends keyof HTMLEhtcApiSelectElementEventMap>(
      type: K,
      listener: (
        this: HTMLEhtcApiSelectElement,
        ev: EhtcApiSelectCustomEvent<HTMLEhtcApiSelectElementEventMap[K]>,
  ...
  interface HTMLEhtcBattleElement extends Components.EhtcBattle, HTMLStencilElement {
    addEventListener<K extends keyof HTMLEhtcBattleElementEventMap>(
      type: K,
      listener: (this: HTMLEhtcBattleElement, ev: EhtcBattleCustomEvent<HTMLEhtcBattleElementEventMap[K]>) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
      type: K,
    ...
    removeEventListener<K extends keyof HTMLEhtcBattleElementEventMap>(
      type: K,
      listener: (this: HTMLEhtcBattleElement, ev: EhtcBattleCustomEvent<HTMLEhtcBattleElementEventMap[K]>) => any,
      options?: boolean | EventListenerOptions,
    ): void;
  ...
  interface HTMLEhtcBattleSelectElement extends Components.EhtcBattleSelect, HTMLStencilElement {
    addEventListener<K extends keyof HTMLEhtcBattleSelectElementEventMap>(
      type: K,
      listener: (
        this: HTMLEhtcBattleSelectElement,
        ev: EhtcBattleSelectCustomEvent<HTMLEhtcBattleSelectElementEventMap[K]>,
      ) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLEhtcBattleSelectElementEventMap>(
      type: K,
      listener: (
        this: HTMLEhtcBattleSelectElement,
        ev: EhtcBattleSelectCustomEvent<HTMLEhtcBattleSelectElementEventMap[K]>,
  ...
  interface HTMLEhtcMemberSelectElement extends Components.EhtcMemberSelect, HTMLStencilElement {
    addEventListener<K extends keyof HTMLEhtcMemberSelectElementEventMap>(
      type: K,
      listener: (
        this: HTMLEhtcMemberSelectElement,
        ev: EhtcMemberSelectCustomEvent<HTMLEhtcMemberSelectElementEventMap[K]>,
      ) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLEhtcMemberSelectElementEventMap>(
      type: K,
      listener: (
        this: HTMLEhtcMemberSelectElement,
        ev: EhtcMemberSelectCustomEvent<HTMLEhtcMemberSelectElementEventMap[K]>,
  ...
  interface HTMLEhtcWrapSelectElement extends Components.EhtcWrapSelect, HTMLStencilElement {
    addEventListener<K extends keyof HTMLEhtcWrapSelectElementEventMap>(
      type: K,
      listener: (
        this: HTMLEhtcWrapSelectElement,
        ev: EhtcWrapSelectCustomEvent<HTMLEhtcWrapSelectElementEventMap[K]>,
      ) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(
    ...
    removeEventListener<K extends keyof HTMLEhtcWrapSelectElementEventMap>(
      type: K,
      listener: (
        this: HTMLEhtcWrapSelectElement,
        ev: EhtcWrapSelectCustomEvent<HTMLEhtcWrapSelectElementEventMap[K]>,
  ...
  interface HTMLPyriteTiePostMissionQuestionsElement
    extends Components.PyriteTiePostMissionQuestions, HTMLStencilElement {}
  ...
  interface HTMLPyriteTiePreMissionQuestionsElement
    extends Components.PyriteTiePreMissionQuestions, HTMLStencilElement {}
  ...
  interface HTMLPyriteXvtPl2CampaignProgressStateElement
    extends Components.PyriteXvtPl2CampaignProgressState, HTMLStencilElement {}
  ...
  interface HTMLPyriteXvtPl2CampaignStatusSpRecordElement
    extends Components.PyriteXvtPl2CampaignStatusSpRecord, HTMLStencilElement {}
  ...
  interface HTMLPyriteXvtPl2FileEditorElement extends Components.PyriteXvtPl2FileEditor, HTMLStencilElement {}
  var HTMLPyriteXvtPl2FileEditorElement: {
    prototype: HTMLPyriteXvtPl2FileEditorElement;
    new (): HTMLPyriteXvtPl2FileEditorElement;
  };
  ...
  interface HTMLPyriteXvtPltBattleProgressStateElement
    extends Components.PyriteXvtPltBattleProgressState, HTMLStencilElement {}
  ...
  interface HTMLPyriteXvtPltCategoryTypeRecordElement
    extends Components.PyriteXvtPltCategoryTypeRecord, HTMLStencilElement {}
  ...
  interface HTMLPyriteXvtPltConnectedPlayerDataElement
    extends Components.PyriteXvtPltConnectedPlayerData, HTMLStencilElement {}
  ...
  interface HTMLPyriteXvtPltEarnedMedalRecordElement
    extends Components.PyriteXvtPltEarnedMedalRecord, HTMLStencilElement {}
  ...
  interface HTMLPyriteXvtPltPlayerRankCountRecordElement
    extends Components.PyriteXvtPltPlayerRankCountRecord, HTMLStencilElement {}
  ...
  interface HTMLPyriteXvtPltTeamResultRecordElement
    extends Components.PyriteXvtPltTeamResultRecord, HTMLStencilElement {}
  ...
  interface HTMLPyriteXvtPltTournamentProgressStateElement
    extends Components.PyriteXvtPltTournamentProgressState, HTMLStencilElement {}
  ...
  interface HTMLPyriteXvtPltaiRankCountRecordElement
    extends Components.PyriteXvtPltaiRankCountRecord, HTMLStencilElement {}
  ...
  interface HTMLPyriteXwaBrfStrElement extends Components.PyriteXwaBrfStr, HTMLStencilElement {}
  var HTMLPyriteXwaBrfStrElement: {
    prototype: HTMLPyriteXwaBrfStrElement;
    new (): HTMLPyriteXwaBrfStrElement;
  };
  ...
  interface HTMLPyriteXwaGlobalUnitElement extends Components.PyriteXwaGlobalUnit, HTMLStencilElement {}
  var HTMLPyriteXwaGlobalUnitElement: {
    prototype: HTMLPyriteXwaGlobalUnitElement;
    new (): HTMLPyriteXwaGlobalUnitElement;
  };
  ...
  interface HTMLPyriteXwaIconElement extends Components.PyriteXwaIcon, HTMLStencilElement {}
  var HTMLPyriteXwaIconElement: {
    prototype: HTMLPyriteXwaIconElement;
    new (): HTMLPyriteXwaIconElement;
  };
  ...
  interface HTMLPyriteXwaRegionElement extends Components.PyriteXwaRegion, HTMLStencilElement {}
  var HTMLPyriteXwaRegionElement: {
    prototype: HTMLPyriteXwaRegionElement;
    new (): HTMLPyriteXwaRegionElement;
  };
  ...
  interface HTMLPyriteXwaTriggerPairElement extends Components.PyriteXwaTriggerPair, HTMLStencilElement {}
  var HTMLPyriteXwaTriggerPairElement: {
    prototype: HTMLPyriteXwaTriggerPairElement;
    new (): HTMLPyriteXwaTriggerPairElement;
  };
  ...
  interface HTMLElementTagNameMap {
    ...
    "pyrite-xvt-pl-2-file-editor": HTMLPyriteXvtPl2FileEditorElement;
    ...
    "pyrite-xwa-brf-str": HTMLPyriteXwaBrfStrElement;
    ...
    "pyrite-xwa-region": HTMLPyriteXwaRegionElement;
    "pyrite-xwa-team": HTMLPyriteXwaTeamElement;
    "pyrite-xwa-trigger": HTMLPyriteXwaTriggerElement;
    "pyrite-xwa-trigger-pair": HTMLPyriteXwaTriggerPairElement;
...
declare namespace LocalJSX {
  ...
  interface IntrinsicElements {
    ...
    "pyrite-xvt-pl-2-file-editor": PyriteXvtPl2FileEditor;
    ...
    "pyrite-xwa-brf-str": PyriteXwaBrfStr;
    ...
    "pyrite-xwa-region": PyriteXwaRegion;
    "pyrite-xwa-team": PyriteXwaTeam;
    "pyrite-xwa-trigger": PyriteXwaTrigger;
    "pyrite-xwa-trigger-pair": PyriteXwaTriggerPair;
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      "pyrite-tie-flight-group": LocalJSX.PyriteTieFlightGroup &
        JSXBase.HTMLAttributes<HTMLPyriteTieFlightGroupElement>;
      "pyrite-tie-flightgroup": LocalJSX.PyriteTieFlightgroup & JSXBase.HTMLAttributes<HTMLPyriteTieFlightgroupElement>;
      "pyrite-tie-flightgroups": LocalJSX.PyriteTieFlightgroups &
        JSXBase.HTMLAttributes<HTMLPyriteTieFlightgroupsElement>;
      ...
      "pyrite-tie-post-mission-questions": LocalJSX.PyriteTiePostMissionQuestions &
        JSXBase.HTMLAttributes<HTMLPyriteTiePostMissionQuestionsElement>;
      "pyrite-tie-pre-mission-questions": LocalJSX.PyriteTiePreMissionQuestions &
        JSXBase.HTMLAttributes<HTMLPyriteTiePreMissionQuestionsElement>;
      ...
      "pyrite-xvt-flight-group": LocalJSX.PyriteXvtFlightGroup &
        JSXBase.HTMLAttributes<HTMLPyriteXvtFlightGroupElement>;
      ...
      "pyrite-xvt-mission-data": LocalJSX.PyriteXvtMissionData &
        JSXBase.HTMLAttributes<HTMLPyriteXvtMissionDataElement>;
      ...
      "pyrite-xvt-pl-2-campaign-progress-state": LocalJSX.PyriteXvtPl2CampaignProgressState &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPl2CampaignProgressStateElement>;
      "pyrite-xvt-pl-2-campaign-record": LocalJSX.PyriteXvtPl2CampaignRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPl2CampaignRecordElement>;
      "pyrite-xvt-pl-2-campaign-state": LocalJSX.PyriteXvtPl2CampaignState &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPl2CampaignStateElement>;
      "pyrite-xvt-pl-2-campaign-status-sp-record": LocalJSX.PyriteXvtPl2CampaignStatusSpRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPl2CampaignStatusSpRecordElement>;
      "pyrite-xvt-pl-2-debrief-record": LocalJSX.PyriteXvtPl2DebriefRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPl2DebriefRecordElement>;
      "pyrite-xvt-pl-2-faction-record": LocalJSX.PyriteXvtPl2FactionRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPl2FactionRecordElement>;
      "pyrite-xvt-pl-2-file-editor": LocalJSX.PyriteXvtPl2FileEditor &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPl2FileEditorElement>;
      "pyrite-xvt-pl-2-file-record": LocalJSX.PyriteXvtPl2FileRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPl2FileRecordElement>;
      "pyrite-xvt-plt-battle-mp-record": LocalJSX.PyriteXvtPltBattleMpRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltBattleMpRecordElement>;
      "pyrite-xvt-plt-battle-progress-state": LocalJSX.PyriteXvtPltBattleProgressState &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltBattleProgressStateElement>;
      "pyrite-xvt-plt-battle-sp-record": LocalJSX.PyriteXvtPltBattleSpRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltBattleSpRecordElement>;
      "pyrite-xvt-plt-battle-state": LocalJSX.PyriteXvtPltBattleState &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltBattleStateElement>;
      "pyrite-xvt-plt-category-type-record": LocalJSX.PyriteXvtPltCategoryTypeRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltCategoryTypeRecordElement>;
      "pyrite-xvt-plt-connected-player-data": LocalJSX.PyriteXvtPltConnectedPlayerData &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltConnectedPlayerDataElement>;
      "pyrite-xvt-plt-earned-medal-record": LocalJSX.PyriteXvtPltEarnedMedalRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltEarnedMedalRecordElement>;
      "pyrite-xvt-plt-faction-record": LocalJSX.PyriteXvtPltFactionRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltFactionRecordElement>;
      "pyrite-xvt-plt-file-record": LocalJSX.PyriteXvtPltFileRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltFileRecordElement>;
      "pyrite-xvt-plt-mission-mp-record": LocalJSX.PyriteXvtPltMissionMpRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltMissionMpRecordElement>;
      "pyrite-xvt-plt-mission-sp-record": LocalJSX.PyriteXvtPltMissionSpRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltMissionSpRecordElement>;
      "pyrite-xvt-plt-player-rank-count-record": LocalJSX.PyriteXvtPltPlayerRankCountRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltPlayerRankCountRecordElement>;
      "pyrite-xvt-plt-team-result-record": LocalJSX.PyriteXvtPltTeamResultRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltTeamResultRecordElement>;
      "pyrite-xvt-plt-tourn-mp-record": LocalJSX.PyriteXvtPltTournMpRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltTournMpRecordElement>;
      "pyrite-xvt-plt-tourn-sp-record": LocalJSX.PyriteXvtPltTournSpRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltTournSpRecordElement>;
      "pyrite-xvt-plt-tourn-team-record": LocalJSX.PyriteXvtPltTournTeamRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltTournTeamRecordElement>;
      "pyrite-xvt-plt-tournament-progress-state": LocalJSX.PyriteXvtPltTournamentProgressState &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltTournamentProgressStateElement>;
      "pyrite-xvt-pltai-rank-count-record": LocalJSX.PyriteXvtPltaiRankCountRecord &
        JSXBase.HTMLAttributes<HTMLPyriteXvtPltaiRankCountRecordElement>;
      ...
      "pyrite-xw-briefing-header": LocalJSX.PyriteXwBriefingHeader &
        JSXBase.HTMLAttributes<HTMLPyriteXwBriefingHeaderElement>;
      ...
      "pyrite-xw-mission-header": LocalJSX.PyriteXwMissionHeader &
        JSXBase.HTMLAttributes<HTMLPyriteXwMissionHeaderElement>;
      ...
      "pyrite-xw-viewport-setting": LocalJSX.PyriteXwViewportSetting &
        JSXBase.HTMLAttributes<HTMLPyriteXwViewportSettingElement>;
      "pyrite-xwa-brf-str": LocalJSX.PyriteXwaBrfStr & JSXBase.HTMLAttributes<HTMLPyriteXwaBrfStrElement>;
      ...
      "pyrite-xwa-flight-group": LocalJSX.PyriteXwaFlightGroup &
        JSXBase.HTMLAttributes<HTMLPyriteXwaFlightGroupElement>;
      "pyrite-xwa-global-cargo": LocalJSX.PyriteXwaGlobalCargo &
        JSXBase.HTMLAttributes<HTMLPyriteXwaGlobalCargoElement>;
      "pyrite-xwa-global-goal": LocalJSX.PyriteXwaGlobalGoal & JSXBase.HTMLAttributes<HTMLPyriteXwaGlobalGoalElement>;
      "pyrite-xwa-global-unit": LocalJSX.PyriteXwaGlobalUnit & JSXBase.HTMLAttributes<HTMLPyriteXwaGlobalUnitElement>;
      ...
      "pyrite-xwa-icon": LocalJSX.PyriteXwaIcon & JSXBase.HTMLAttributes<HTMLPyriteXwaIconElement>;
      ...
      "pyrite-xwa-mission-data": LocalJSX.PyriteXwaMissionData &
        JSXBase.HTMLAttributes<HTMLPyriteXwaMissionDataElement>;
      ...
      "pyrite-xwa-region": LocalJSX.PyriteXwaRegion & JSXBase.HTMLAttributes<HTMLPyriteXwaRegionElement>;
      ...
      "pyrite-xwa-trigger-pair": LocalJSX.PyriteXwaTriggerPair &
        JSXBase.HTMLAttributes<HTMLPyriteXwaTriggerPairElement>;
